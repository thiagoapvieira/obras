...
Route::middleware(['cors'])->group(function(){
    ...
    //webserver api    
    Route::get('webservice/obras/filter/textual/{pesq}', [WebServiceController::class,'filter_get']);

    Route::post('webservice/obras/filter', [WebServiceController::class,'filter_post']);
