            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        -->
                                            <td>
                                                <p class="text-center">R$ {{ number_format($value->valor_total, 2, ',', '.') }}</p>
                                            </td>
                                            ...
                                            <td>
                                                <p class="text-center">{{ $value->percentual_execucao_financeira }}%</p>
                                            </td>
                                            <td>
                                                <p class="text-center">{{ $value->percentual_execucao_fisica }}%</p>
                                            </td>
